        ...
        <div className="container ">
          <div className="row">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={service1} alt="img" />
                </div>
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={service2} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={service3} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={service4} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={s1} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={s2} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={s6} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
            ...
            <div className="col-xl-3 col-md-6 col-12 mb-4">
              <div className="service-innerbox">
                <div className="service-img">
                  <img className="rounded card" src={s4} alt="img" />
                </div>
                <div className="service-content position-relative">
                  <center>
                    <div className="cor-service-icon shadow-lg card rounded">
