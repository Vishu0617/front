                ...
                <div className="skill-progress-area">
                    <div className="single-progressbar">
                        ...
                        <div className="progress-item" id="progress-running">
                            <div className="progress-bg">
                                <div id="progress" className="progress-rate Freight" data-value="85" style={{width: 250}}>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="single-progressbar">
                        ...
                        <div className="progress-item" id="progress-running-1">
                            <div className="progress-bg">
                                <div id="progress-1" className="progress-rate" data-value="80" style={{width: 480}}>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="single-progressbar">
                        ...
                        <div className="progress-item">
                            <div className="progress-bg">
                                <div id="progress-2" className="progress-rate" data-value="90" style={{width: 490}}>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="single-progressbar">
                        ...
                        <div className="progress-item mb-0" id="progress-running-3">
                            <div className="progress-bg">
                                <div id="progress-3" className="progress-rate" data-value="75" style={{width: 425}}>
                                </div>
                            </div>
                        </div>
                    </div>
